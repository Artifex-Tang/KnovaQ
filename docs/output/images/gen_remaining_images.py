...
# ============================================================================
er_svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1300 1080" font-family="Microsoft YaHei, SimHei, sans-serif">
  <defs>
    <style>
      ...
      .domain-box { fill: none; stroke-dasharray: 8,4; rx: 10; stroke-width: 1.5; }
      .domain-label { font-size: 13px; font-weight: bold; }
    </style>
  </defs>

  <text x="650" y="35" text-anchor="middle" class="title">知枢(KnovaQ) 数据库逻辑设计 ER图</text>

  <!-- Domain group boxes (behind entities) -->
  <!-- 知识库域 -->
  <rect class="domain-box" x="15" y="48" width="1175" height="200" stroke="#16a34a"/>
  <text x="25" y="68" class="domain-label" fill="#16a34a">知识库域 (kb_)</text>

  <!-- 维修服务域 -->
  <rect class="domain-box" x="15" y="300" width="1030" height="255" stroke="#2563eb"/>
  <text x="25" y="320" class="domain-label" fill="#2563eb">维修服务域 (rs_)</text>

  <!-- 问题登记域 -->
  <rect class="domain-box" x="15" y="600" width="500" height="225" stroke="#9333ea"/>
  <text x="25" y="620" class="domain-label" fill="#9333ea">问题登记域 (ir_)</text>

  <!-- 系统管理域 -->
  <rect class="domain-box" x="540" y="600" width="745" height="225" stroke="#E65100"/>
  <text x="550" y="620" class="domain-label" fill="#E65100">系统管理域 (sys_)</text>

  <!-- 调度任务域 -->
  <rect class="domain-box" x="15" y="860" width="450" height="125" stroke="#6A1B9A"/>
  <text x="25" y="880" class="domain-label" fill="#6A1B9A">调度任务域 (QRTZ_)</text>
  ...
  <g transform="translate(1200, 620)">
    <rect class="entity-box" x="0" y="0" width="170" height="150"/>
    <rect class="entity-header" x="0" y="0" width="170" height="30" rx="8"/>
    <text x="85" y="20" text-anchor="middle" class="entity-header-text">sys_menu 菜单</text>
    <text x="10" y="50" class="pk-text">PK menu_id</text>
    <text x="10" y="66" class="fk-text">FK parent_id 父菜单</text>
    <text x="10" y="82" class="field-text">menu_name 菜单名</text>
    <text x="10" y="98" class="field-text">path 路由地址</text>
    <text x="10" y="114" class="field-text">menu_type 菜单类型</text>
    <text x="10" y="130" class="field-text">perms 权限标识</text>
  </g>

  <!-- QRTZ tables (调度任务域) -->
  <g transform="translate(30, 890)">
    <rect class="entity-box" x="0" y="0" width="200" height="80" style="fill:#F3E5F5;stroke:#6A1B9A"/>
    <rect x="0" y="0" width="200" height="30" rx="8" style="fill:#6A1B9A"/>
    <text x="100" y="20" text-anchor="middle" style="fill:white;font-size:14px;font-weight:bold">QRTZ_JOB_DETAILS</text>
    <text x="10" y="50" class="pk-text">PK sched_name + job_name</text>
    <text x="10" y="66" class="field-text">job_class 任务类</text>
  </g>

  <g transform="translate(260, 890)">
    <rect class="entity-box" x="0" y="0" width="200" height="80" style="fill:#F3E5F5;stroke:#6A1B9A"/>
    <rect x="0" y="0" width="200" height="30" rx="8" style="fill:#6A1B9A"/>
    <text x="100" y="20" text-anchor="middle" style="fill:white;font-size:14px;font-weight:bold">QRTZ_TRIGGERS</text>
    <text x="10" y="50" class="pk-text">PK sched_name + trigger_name</text>
    <text x="10" y="66" class="fk-text">FK job_name 关联任务</text>
  </g>
  ...
  <g transform="translate(30, 1010)">
    ...
    <rect x="340" y="0" width="15" height="10" fill="none" stroke="#666" stroke-dasharray="4,2" rx="2"/>
    <text x="360" y="10" class="field-text">域分组</text>
  </g>
</svg>'''
...
# ============================================================================
test_env_svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1100 740" font-family="Microsoft YaHei, SimHei, sans-serif">
  <defs>
    <style>
